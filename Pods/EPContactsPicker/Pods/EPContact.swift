...
public class EPContact: NSObject {
    ...
    public var onlyPhoneNumbers = [(String)]()
    ...
    public init (contact: CNContact)
    {
        ...
        for onlyPhoneNumber in contact.phoneNumbers {
            let onlyphone = onlyPhoneNumber.value as! CNPhoneNumber
            onlyPhoneNumbers.append((onlyphone.stringValue))
        }
